package io.pit.jobs.sessions;

import io.pit.jobs.enrich.ApicurioAvroFlinkDeserializer; // reuse deserializer
...
public class SessionsJob {
    public static void main(String[] args) throws Exception {
        ...
        String topic = System.getProperty("kafka.topic", "pit.events_raw"); // 可切换到 events_enriched

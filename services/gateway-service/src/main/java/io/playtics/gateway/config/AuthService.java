...
public class AuthService {
    ...
    public AuthService(Environment env) {
        this.localSecrets = Binder.get(env).bind("playtics.auth.keys", Map.class).orElse(Map.of());
        this.controlUrl = Binder.get(env).bind("playtics.control.url", String.class).orElse(null);

...
public class AvroPublisher {
    ...
    @Value("${pit.kafka.topic}")
    private String topic;

    @Value("${pit.kafka.registryUrl}")
    private String registryUrl;

    @Value("${pit.kafka.producer.lingerMs:5}")
    private int lingerMs;

    @Value("${pit.kafka.producer.batchSize:65536}")
    private int batchSize;

    @Value("classpath:schemas/pit-event.avsc")
